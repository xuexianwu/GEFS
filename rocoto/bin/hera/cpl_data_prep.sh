...
atminitdir=/scratch2/NCEPDEV/ensemble/Bing.Fu/stmp/o/retrop2/nwges/dev
ocninitdir=/scratch2/NCEPDEV/ensemble/noscrub/Wei.Li/MOM6_IC/output
iceinitdir=/scratch2/NCEPDEV/ensemble/noscrub/Wei.Li/CICE6_IC/CPC_050
wavinitdir=/scratch2/NCEPDEV/ensemble/Bing.Fu/common/wav
for mem in $MEMLIST
do
...
cp -r $iceinitdir/cice5_model_0.50.cpc.res_${CDATE}.nc $ICSDIR/$mem/FV3ICS/ice/cice5_model_0.50.res_${CDATE}.nc
if [ $cplwav = ".true." ]; then
