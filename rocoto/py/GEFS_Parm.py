...
def create_gets_dev_parm(dicBase, listBaseParm):
    ...
    for sVarName in listBaseParm:
        ...
        if sVarName.upper() == 'DO_SKEB':
            fh.write('export DO_OCN_PERT_EPBL="YES"\n')
            fh.write('export DO_OCN_SPPT="YES"\n')
            fh.write('export pert_mp=".true."\n')
            fh.write('export pert_radtend=".true."\n')
            fh.write('export DO_LAND_PERT="NO"\n')
            fh.write('export MOM6_IAU="True"\n')
            fh.write('\n')
            fh.write('if [[ $RUNMEM = "gec00" ]]; then\n')
            fh.write('    export DO_SPPT="NO"\n')
            fh.write('    export DO_SHUM="NO"\n')
            fh.write('    export DO_SKEB="NO"\n')
            fh.write('    export DO_VC="NO"\n')
            fh.write('    export DO_OCN_PERT_EPBL="NO"\n')
            fh.write('    export DO_OCN_SPPT="NO"\n')
            fh.write('    export pert_mp=".false."\n')
            fh.write('    export pert_radtend=".false."\n')
            fh.write('    export DO_LAND_PERT="NO"\n')
            fh.write('    export MOM6_IAU="False"\n')
